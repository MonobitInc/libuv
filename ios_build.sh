...
SDKOPT=-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS${IOSVER}.sdk -arch arm64 -arch armv7 -arch armv7s -miphoneos-version-min=12.0  
